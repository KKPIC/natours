...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      maxlength: [
        40,
        'A tour name must be at least less or equal than 40 characters',
      ],
      minlength: [
        10,
        'A tour name must be at least more or equal than 10 characters',
      ],
...
// to remove the secret query in different GET
